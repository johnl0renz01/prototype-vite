...
export default function StudentDetail() {
  ...
  return (
    <>
      <div className="my-10 lg:scale-100 md:scale-95 w-10/12 mx-auto lg:fixed top-1/1 left-0 right-0 place-items-center  p-6 rounded-10xl border-l-12 border-b-12 border-yellow-700 bg-mainBGBrown border-r-12 border-r-brTwo shadow-2xl shadow-yellow-400">
          ...
          <div className="grid sm:grid-cols-1 lg:grid-cols-2">
            <div className="">
              ...
              <p className="lg:text-xl sm:text-md text-gray-800 leading-4">
                delacruz.johnlorenz.naga@school.edu.ph
              </p>
              <br></br>
