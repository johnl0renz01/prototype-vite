...
function EditAccount() {
          ...
          if (result.hasOwnProperty(obj)) {
            for (var prop in result[obj]) {
              if (result[obj].hasOwnProperty(prop)) {
                test.push(prop + ":" + result[obj][prop]);
              }
            }
          }
        }
  ...
  //CHANGE PASSWORD
  const [isChange, setChangeState] = useState(false);
  ...
  return (
    <>
          ...
          <div className=" border-yellow-900/40 border-l-12 border-b-12 rounded-bl-5xl rounded-br-5xl border-r-yellow-900/20 border-r-12">
            ...
            >
              <main className="py-12 pr-12 min-w-fit font-poppins font-semibold  overflow-hidden">
                ...
                <div className="flex text-center w-full mt-16 pl-12">
                  <a
                  ...
                  <div className="flex grow justify-end  ">
                    ...
                    >
                      <span className="pl-2 text-xl flex justify-center">
                        Apply Changes
                        <VscCheckAll className="ml-2 mt-1 lg:text-2xl" />
                      </span>
                    </button>
                  </div>
                </div>
      ...
      <EditAccountModal onClose={handleOnCloseModal} visible={showModal} />
    </>
  );
}
