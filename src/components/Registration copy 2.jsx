...
function Registration() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('resize', setWidthAdmin);
    setWidthAdmin();
  }, []);

  function setWidthAdmin() {
    ...
    <>
      ...
      >
        <div className="relative mx-auto p-8 w-full">
          ...
          <div className="">
            <div className="w-full  mt-4  text-2xl text-black grid place-items-center font-poppins font-semibold overflow-hidden">
