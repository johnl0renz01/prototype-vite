    ...
    if (countTally === 0) {
      ...
      */
      ...
      if (fixedEquationSteps.length === 1) {
        hintMessage.push(FeedbackList.HelpMessage("stepFinal"));
      } else if (fixedEquationSteps.length === 2) {
        hintMessage.push(FeedbackList.HelpMessage("stepSimplify"));
        hintMessage.push(FeedbackList.HelpMessage("stepFinal"));
      } else if (fixedEquationSteps.length === 3) {
        hintMessage.push(FeedbackList.HelpMessage("stepArrange"));
        hintMessage.push(FeedbackList.HelpMessage("stepSimplify"));
        hintMessage.push(FeedbackList.HelpMessage("stepFinal"));
      } else if (fixedEquationSteps.length === 4) {
        hintMessage.push(FeedbackList.HelpMessage("stepArithmetic"));
        hintMessage.push(FeedbackList.HelpMessage("stepArrange"));
        hintMessage.push(FeedbackList.HelpMessage("stepSimplify"));
        hintMessage.push(FeedbackList.HelpMessage("stepFinal"));
      }
...
*/
  ...
  function displayCorrect() {
    ...
    if (data >= 6) {
      ...
      setResponse(FeedbackList.HelpMessage("correct1"));
      setSubtext(FeedbackList.HelpMessage("subCorrect1"));
    } else if (data >= 4) {
      ...
      setResponse(FeedbackList.HelpMessage("correct2"));
      setSubtext(FeedbackList.HelpMessage("subCorrec2"));
    } else {
      setImageLink("PIA-Happy");
      setResponse(FeedbackList.HelpMessage("correct3"));
      setSubtext(FeedbackList.HelpMessage("subCorrect2"));
    }
  ...
  function displayWrong() {
    ...
    if (dataCorrect == 1) {
      ...
      setResponse(FeedbackList.HelpMessage("wrong1"));
      ...
      setImageLink("PIA-Sad3");
      setResponse(FeedbackList.HelpMessage("wrong1"));
    } else if (dataWrong >= 1) {
      setImageLink("PIA-Sad2");
      setResponse(FeedbackList.HelpMessage("wrong1"));
    } else {
  ...
  function displayMotivation() {
    ...
    setResponse(FeedbackList.HelpMessage(message));
    setSubtext("");
  ...
  function displayInspiration() {
    ...
    setResponse(FeedbackList.HelpMessage("motivation4"));
    setSubtext("");
  ...
  function displayMad() {
    ...
    if (streakCount >= 2) {
      ...
      setImageLink("PIA-Mad");
      setResponse(
        "Input appropriate answer for the given problem. Please take this seriously and answer the given problem."
      );
      setSubtext("");
      changeResponseColor(wrongColor);
  ...
  function hintModeResponse() {
    ...
    let hintIndex = parseInt(
      JSON.parse(window.localStorage.getItem("FINISHED_STEPS")) - 1
    );
