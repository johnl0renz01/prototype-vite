        ...
        <div className="relative mx-auto p-8 w-full text-gray-700">
          ...
          >
            ...
            <form
              ...
              autoComplete="off"
            >
              <main className="hdScreen:pt-10 semihdScreen:pt-9 laptopScreen:pt-8 averageScreen:pt-6 xs:pt-4 pb-12 pr-12 min-w-fit hdScreen:text-lg semihdScreen:text-lg laptopScreen:text-base averageScreen:text-base xs:text-xs   overflow-hidden">
                <div className="grid grid-cols-3 gap-3 ">
                  ...
                  <div>
                    <div className="inline-flex w-full">
                      <label
                        htmlFor="firstName"
                        className="md:inline-block xs:hidden mt-2 pr-2 text-right "
                      >
                        Given Name:{' '}
                      </label>
                      <input
                  ...
                  <div>
                    <div className="inline-flex w-full">
                      <label
                        htmlFor="middleName"
                        className="md:inline-block xs:hidden pt-2 pr-2 text-right "
                      >
                        Middle Name:{' '}
                      </label>
                      <input
                ...
                >
                  ...
                  <div>
                    <div className="inline-flex w-full ">
                      ...
                      <div className="grow mt-2.5 w-full">
                        <input
                          name="sex"
                          type="radio"
                          className=""
                  ...
                  <div className="col-span-2">
                    <div className="inline-flex w-full">
                      <label
                        htmlFor="groupType"
                        className="md:inline-block xs:hidden pt-2 pr-2 text-right lg:w-[120px]"
                      >
                        Group Type:{' '}
                      </label>
                ...
                >
                  ...
                  <div>
                    <div className="inline-flex w-full">
                      <label
                        htmlFor="gradeLevel"
                        className="md:inline-block xs:hidden pt-2 pr-2 text-right lg:w-[136px]"
                      >
                        Grade Level:{' '}
                      </label>
                      <select
                          ...
                          <tbody className="relative ">
                            {studentList.map((row, counter) =>
                              row.Role != ' ' ? (
                                ...
                                >
                                  <td className="lg:pl-8 lg:text-base md:text-sm sm:text-sm py-[10px]">
                                  ...
                                  {Object.values(row).map((value, index) =>
                                    index > 1 && index != 3 ? (
                                      <td
                                        name={value}
                                        key={index}
                                        className={`  lg:text-base md:text-sm sm:text-sm py-[10px]
                                        `}
                                      >
