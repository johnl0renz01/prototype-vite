...
export default function ReportCard() {
  ...
  return (
    <>
      <div
        className={`absolute top-0  bg-gradient-to-t from-[#e2e2e2] via-[#f1f1f1] to-[#ffffff] h-screen
      ${
        navbarWidth == 143
          ? 'w-[calc(100%-143px)] left-[143px]'
          : navbarWidth == 127
          ? 'w-[calc(100%-127px)] left-[127px]'
          : navbarWidth == 111
          ? 'w-[calc(100%-111px)] left-[111px]'
          : navbarWidth == 95
          ? 'w-[calc(100%-95px)] left-[95px]'
          : 'w-[calc(100%-143px)] left-[143px]'
      }`}
      >
        <section
