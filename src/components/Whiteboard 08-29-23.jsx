          ...
          >
            ...
            >
              ...
              >
                <section id="tutorialAlbum">
                  <div className=" grid grid-cols-4 gap-4 grid-rows-3 bg-gradient-to-t from-[#cbcbcb] via-[#f0f0f0] to-[#cbcbcb] h-full">
                    <div className="relative border-4 border-gray-700 hover:border-white  break-all overflow-hidden shadow drop-shadow-[0_3px_0px_rgba(0,0,0,0.3)]">
                      <div className="hover:blur-[3px]">
                        <img
                          className="border-4 border-slate-700 object-cover -mt-6"
            ...
            >
              ...
              >
                <div
                  id="image_bg"
                  className={`z-10 hdScreen:w-[19rem] semihdScreen:w-[14rem] laptopScreen:w-[13rem] averageScreen:w-[12rem] relative flex items-center text-center justify-center rounded-full bg-slate-200   object-cover w-full mt-3 hdScreen:px-10 semihdScreen:px-5 pt-2 ml-[70px] mr-[20px] overflow-hidden ${
                    isHelp
                      ? 'hdScreen:w-[19rem] semihdScreen:w-[14rem] laptopScreen:w-[13rem] averageScreen:w-[12rem] hover:border-[5px] hover:border-red-500'
                      : ''
                  }`}
                >
                  <img
