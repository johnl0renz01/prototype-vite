...
const ImageModalAdmin = ({ visible, onClose, onContinue }) => {
  const navigate = useNavigate();

  const [imageLink, setImageLink] = useState('manage-accounts-home');

  useEffect(() => {
    var link = JSON.parse(window.sessionStorage.getItem('IMAGE_LINK_ADMIN'));
            ...
            <div className=" relative mx-auto scale-95 rounded-md">
              <div className="">
                <img
                  ...
                  src={require(`../assets/admin_guide/${imageLink}.png`)}
                  alt=""
                />
              </div>
            </div>
