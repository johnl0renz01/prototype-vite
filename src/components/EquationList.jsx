...
export default function EquationList() {
  ...
  function getEquations() {
    ...
    axios
      .get(`https://pia-sfe.online/api/equationsEasy/${tableName}`)
      .then(function (response) {
        ...
        axios
          .get(`https://pia-sfe.online/api/equationsAverage/${tableName}`)
          .then(function (response) {
            for (let i = 0; i < response.data.length; i++) {
              //console.log(response.data[i]);
            ...
            axios
              .get(`https://pia-sfe.online/api/equationsDifficult/${tableName}`)
              .then(function (response) {
                for (let i = 0; i < response.data.length; i++) {
                  //console.log(response.data[i]);
  ...
  function removeEquation(equation) {
    ...
    axios
      .post(
        `https://pia-sfe.online/api/removeEquation/${equationString}@${tableName}`
      )
      .then(function (response) {
  ...
  const handleDragAndDrop = results => {
    ...
    axios
      .post(
        `https://pia-sfe.online/api/editEquationType/${equationType}@${stringRequest}@${tableName}`
      )
      .then(function (response) {
