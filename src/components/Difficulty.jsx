  ...
  return (
    <>
      <section>
        ...
        <div className="hdScreen:scale-[100%] semihdScreen:scale-[95%] laptopScreen:scale-[85%] averageScreen:scale-[75%] hdScreen:-mt-6 semihdScreen:-mt-6 laptopScreen:-mt-6 averageScreen:-mt-14 mx-auto lg:w-full min-h-[calc(100vh-5.5rem)]  flex items-center justify-center select-none ">
          <div className="">
