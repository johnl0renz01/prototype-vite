        ...
        <div className="relative mx-auto p-8 w-full text-gray-700">
          ...
          <div className=" inline-flex lg:px-6 hdScreen:py-5 semihdScreen:py-3 laptopScreen:pb-3 averageScreen:pb-2 sm:pb-1 xs:pb-0.5">
            ...
            <div className="flex mt-[0.7rem] lg:text-lg xs:text-xs px-2">
              <button
                className={`cursor-default bg-gray-300 text-gray-300 lg:px-2 sm:px-2 xs:px-1 rounded-lg lg:w-24 relative overflow-hidden before:absolute before:inset-0 before:-translate-x-full before:bg-gradient-to-r before:from-transparent before:via-white/50  before:animate-[shimmer_2s_infinite]`}
              >
                Student
              </button>
              <button
                className={`cursor-default bg-gray-300 text-gray-300  ml-4  lg:px-2 xs:px-1 rounded-lg lg:w-24 relative overflow-hidden before:absolute before:inset-0 before:-translate-x-full before:bg-gradient-to-r before:from-transparent before:via-white/50  before:animate-[shimmer_2s_infinite] `}
              >
                Teacher
              </button>
            </div>
