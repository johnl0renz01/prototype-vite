        ...
        <section className="relative mx-auto p-8 w-full">
          ...
          <div className="mt-1.5 ">
            <div className="lg:text-lg xs:text-xs tracking-wide">
              Welcome to the section list. Below are the various sections that
          ...
          <div className="mt-3">
            <div className="lg:text-lg xs:text-xs flex ">
              <div className="rounded-lg bg-gray-200">
                <div className="grid text-xl font-semibold tracking-wide text-gray-700">
                  <div className="text-center p-2">7 - Aguinaldo</div>
                  <div className="text-center p-2">47 students </div>
                </div>
                <button
                  onClick={reportCard}
                  className={`  lg:px-2 xs:px-1 py-1 rounded-b-lg w-full hover:bg-gray-400 transition duration-200 ${
                    category == 'ReportCard'
