...
const ForgotPasswordModal = ({ visible, onClose, onContinue }) => {
        ...
        <div className="bg-white hdScreen:w-1/3 rounded lg:text-lg xs:text-xs shadow-md ">
          ...
          <div className=" text-center text-gray-800">
            ...
            >
              ...
              <div className="flex justify-between pl-10 pr-8 text-center border-t-2 border-gray-300 py-3">
                <button
                  type="button"
                  onClick={handleReset}
                  className={`relative  h-9 w-28  rounded-lg font-semibold  transition duration-300 text-white bg-gray-500/90 hover:bg-gray-600/90 `}
                >
                ...
                <button
                  type="button"
                  onClick={handleReset}
                  className={`relative  h-9 w-28  rounded-lg font-semibold  transition duration-300 text-white bg-lime-600/90 hover:bg-gray-700/90 `}
                >
                  <span className="font-normal lg:text-lg xs:text-xs flex justify-center">
                    Proceed
                  </span>
