...
(48, 'Mark Paul', 'Borja', 'Ramos', '2013-07-30', 9, 'Male', 'Grade 7', 'Aguinaldo', 'Facial Group', 'ramos.markpaul@sanfrancisco.edu.ph', '$2y$10$cjOEThU4JyTAEf6FP5Yf9O9dc9hxSJC0AvhNKCMKf8rsvJkYZeZhi'),
...
(66, 'Triple', '', 'H', '2013-12-25', 9, 'Male', 'Grade 7', 'Bonifacio', 'Facial Group', 'h.triple@sanfrancisco.edu.ph', '$2y$10$I3lnbHd4UV5RN3SX8zf.r.ifvoKIKjvlEYdIJMD4i0Fn90OB2/9Ga'),
(68, 'Chris', '', 'Cornell', '2013-12-09', 9, 'Male', 'Grade 7', 'Aguinaldo', 'Facial Group', 'cornell.chris@sanfrancisco.edu.ph', '$2y$10$T0YXgusm2RQn2OPCup.90Ob8ymuO6h2ctUyYIwnTcDjUC9nHxMlEC'),
(69, 'Beethoven', '', 'Martin', '2013-12-18', 9, 'Male', 'Grade 7', 'Aguinaldo', 'Facial Group', 'martin.beethoven@sanfrancisco.edu.ph', '$2y$10$BX9MOXnMHGdCgRm7GaNY.uM2YMc1vBKUDmvffK0qCw69B2DfyerXm');
...
INSERT INTO `cornell_chris` (`SessionID`, `SessionType`, `Score`, `TimeSpent`, `TimeStamp`, `TimeStart`, `ExpressionAngry`, `ExpressionHappy`, `ExpressionSad`, `ExpressionSurprised`) VALUES
...
INSERT INTO `h_triple` (`SessionID`, `SessionType`, `Score`, `TimeSpent`, `TimeStamp`, `TimeStart`, `ExpressionAngry`, `ExpressionHappy`, `ExpressionSad`, `ExpressionSurprised`) VALUES
(4, 'Easy', 1, '00:01:16', 'Apr 29, 2023 - 04:22 PM', '29-04-2023 16:22:23', '0', '1', '1', '0'),
(5, 'Easy', 0, '0', 'Apr 29, 2023 - 08:24 PM', '29-04-2023 20:24:44', '', '', '', '');
...
INSERT INTO `ramos_markpaul` (`SessionID`, `SessionType`, `Score`, `TimeSpent`, `TimeStamp`, `TimeStart`, `ExpressionAngry`, `ExpressionHappy`, `ExpressionSad`, `ExpressionSurprised`) VALUES
...
--
ALTER TABLE `equation_list`
  MODIFY `EquationID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `h_triple`
  MODIFY `SessionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `ramos_markpaul`
  MODIFY `SessionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `user_logs`
  MODIFY `inputID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1699;
