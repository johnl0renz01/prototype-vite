...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2023 at 03:19 PM
...
(45, 'Average', 0, '0', 'Apr 22, 2023 - 03:29 AM', '22-04-2023 03:29:59', '', '', '', '');
...
--
ALTER TABLE `delacruz_johnlorenz`
  MODIFY `SessionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `equation_list`
  MODIFY `EquationID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `user_logs`
  MODIFY `inputID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1613;
